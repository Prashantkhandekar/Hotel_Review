...
filename = 'C:/Users/anupsv/Hotel Review Dep/nlp_model.pkl'
naive_bayes_model = pickle.load(open(filename, 'rb'))
logistic_regression_model = pickle.load(open('C:/Users/anupsv/Hotel Review Dep/logistic_regression_model.pkl', 'rb'))
cv_naive=pickle.load(open('C:/Users/anupsv/Hotel Review Dep/tranform.pkl','rb'))
cv_logistic=pickle.load(open('C:/Users/anupsv/Hotel Review Dep/transform_logistic.pkl','rb'))
